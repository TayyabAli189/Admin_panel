                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h2 class="card-title">CPP</h2>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('cpp')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row col-md-8">
                                        <label for="inputEmail3" class="col-sm-3">CPP Id</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="cpp_name" class="form-control" id="" placeholder="">
                                        </div>
                                    </div>

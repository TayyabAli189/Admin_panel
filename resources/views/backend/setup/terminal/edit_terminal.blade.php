                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" role="form" method="post" action="{{route('store.terminal')}}" enctype="multipart/form-data">
                                @csrf

                                <div class="card-body">
                                    <div class="form-group row col-md-8">
                                        <label for="inputEmail3" class="col-sm-3">Terminal Id</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="terminal_name" class="form-control" id="" placeholder="">
                                        </div>
                                    </div>

                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="" class="form-control col-sm-2" placeholder="Source Station" disabled>
                                                        <input type="" class="form-control col-sm-2" placeholder="Source CPP" disabled>
                                                        <input type="" class="form-control col-sm-2" placeholder="Booking No" disabled>
                                                        <input type="" class="form-control col-sm-3" placeholder="Item Description" disabled>
                                                        <input type="" class="form-control col-sm-1" placeholder="Weight" disabled>
                                                        <input type="" class="form-control col-sm-1" placeholder="Barcode" disabled>
